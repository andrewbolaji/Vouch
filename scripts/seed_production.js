...
const restaurants = [
  // Houston
  { id: "hou-1", cityId: "houston", name: "The Puddery", cuisine: "Dessert Bar", imageUrl: "placeholder://restaurant", description: "Warm bread pudding in every flavor you did not know you needed. The line is the proof.", rank: 1, voteCount: 2847, priceLevel: 2, locations: [{ name: "Sugar Land", address: "2643 Town Center Blvd, Sugar Land, TX 77479", latitude: 0, longitude: 0 }], vibeTags: ["Sweet Tooth", "Worth the Wait", "Date Night"] },
  { id: "hou-2", cityId: "houston", name: "Cool Runnings", cuisine: "Jamaican", imageUrl: "placeholder://restaurant", description: "Jerk chicken and oxtail that make you forget you are in Texas. Island vibes, Houston heat.", rank: 2, voteCount: 2534, priceLevel: 2, locations: [{ name: "Southwest Houston", address: "7610 Bissonnet St, Houston, TX 77074", latitude: 0, longitude: 0 }], vibeTags: ["Flavor Bomb", "Casual", "Hidden Gem"] },
  { id: "hou-3", cityId: "houston", name: "Corkscrew BBQ", cuisine: "BBQ", imageUrl: "placeholder://restaurant", description: "Pitmaster Will Buckman cooks over all-wood fires. Get there early or eat somewhere else.", rank: 3, voteCount: 2298, priceLevel: 2, locations: [{ name: "Spring", address: "26608 Keith St, Spring, TX 77373", latitude: 0, longitude: 0 }], vibeTags: ["Worth the Drive", "No Frills", "Cash Friendly"] },
  { id: "hou-4", cityId: "houston", name: "Dona Leti's", cuisine: "Mexican", imageUrl: "placeholder://restaurant", description: "Family recipes from Monterrey served out of a tiny spot that punches way above its size.", rank: 4, voteCount: 2087, priceLevel: 1, locations: [{ name: "Northside", address: "611 N Durham Dr, Houston, TX 77007", latitude: 0, longitude: 0 }], vibeTags: ["Cash Friendly", "No Frills", "Flavor Bomb"] },
  { id: "hou-5", cityId: "houston", name: "Hidden Omakase", cuisine: "Japanese", imageUrl: "placeholder://restaurant", description: "A speakeasy sushi counter you have to know about. Eight seats, one chef, zero compromises.", rank: 5, voteCount: 1876, priceLevel: 4, locations: [{ name: "EaDo", address: "Houston, TX", latitude: 0, longitude: 0 }], vibeTags: ["Special Occasion", "Omakase", "Hidden Gem"] },
  { id: "hou-6", cityId: "houston", name: "Le Jardinier", cuisine: "French", imageUrl: "placeholder://restaurant", description: "Vegetable-forward French fine dining in the Museum District. Light, precise, beautiful.", rank: 6, voteCount: 1654, priceLevel: 4, locations: [{ name: "Museum District", address: "1110 Main St, Houston, TX 77002", latitude: 0, longitude: 0 }], vibeTags: ["Date Night", "Chef-Driven", "Clean Vibes"] },
  { id: "hou-7", cityId: "houston", name: "Lost and Found", cuisine: "Cocktail Bar + Small Plates", imageUrl: "placeholder://restaurant", description: "Craft cocktails in a moody Montrose bar. The food menu is short and every item lands.", rank: 7, voteCount: 1432, priceLevel: 3, locations: [{ name: "Montrose", address: "2606 Dunlavy St, Houston, TX 77006", latitude: 0, longitude: 0 }], vibeTags: ["Good Drinks", "Date Night", "Cozy"] },
  { id: "hou-8", cityId: "houston", name: "Mensho", cuisine: "Ramen", imageUrl: "placeholder://restaurant", description: "Tokyo-born ramen shop with a tori paitan broth that locals queue for on weeknights.", rank: 8, voteCount: 1298, priceLevel: 2, locations: [{ name: "Midtown", address: "3014 Milam St, Houston, TX 77006", latitude: 0, longitude: 0 }], vibeTags: ["Quick Bite", "Cozy", "Neighborhood Favorite"] },
  { id: "hou-9", cityId: "houston", name: "Taste Bar + Kitchen", cuisine: "New American", imageUrl: "placeholder://restaurant", description: "Small plates and big flavors in a space that feels like a dinner party you got lucky enough to attend.", rank: 9, voteCount: 1156, priceLevel: 3, locations: [{ name: "Midtown", address: "3015 Bagby St, Houston, TX 77006", latitude: 0, longitude: 0 }], vibeTags: ["Trendy", "Group Friendly", "Chef-Driven"] },
  { id: "hou-10", cityId: "houston", name: "Tatemo", cuisine: "Japanese Izakaya", imageUrl: "placeholder://restaurant", description: "A Michelin-recognized izakaya tucked into Rice Village. Sake list alone is worth the visit.", rank: 10, voteCount: 1087, priceLevel: 3, locations: [{ name: "Rice Village", address: "2438 Rice Blvd, Houston, TX 77005", latitude: 0, longitude: 0 }], vibeTags: ["Hidden Gem", "Date Night", "Chef-Driven"] },
...
const insiderNotes = {
  "hou-1": { restaurantId: "hou-1", whatToOrder: "Banana pudding bread pudding. Trust this.", insiderTip: "Go on a weeknight. Weekend lines wrap the building." },
  "hou-2": { restaurantId: "hou-2", whatToOrder: "Jerk chicken with rice and peas, and a ginger beer.", insiderTip: "The oxtail sells out early. Call ahead." },
  "hou-3": { restaurantId: "hou-3", whatToOrder: "Brisket and pork ribs. Skip the sides, get more meat.", insiderTip: "Arrive by 10 AM on weekends or the brisket is gone." },
  "hou-4": { restaurantId: "hou-4", whatToOrder: "Barbacoa tacos and the agua fresca of the day.", insiderTip: "Cash only. The line moves fast." },
  "hou-5": { restaurantId: "hou-5", whatToOrder: "The omakase. There is no menu. Trust the chef.", insiderTip: "Book weeks ahead. Walk-ins do not exist." },
  "hou-6": { restaurantId: "hou-6", whatToOrder: "The seasonal tasting menu. Every course surprises.", insiderTip: "Sit on the terrace if the weather allows it." },
  "hou-7": { restaurantId: "hou-7", whatToOrder: "The Old Fashioned and the charcuterie board.", insiderTip: "The back patio is the real experience." },
  "hou-8": { restaurantId: "hou-8", whatToOrder: "Tori paitan ramen with an extra egg.", insiderTip: "Go at 5 PM on a Tuesday. No wait." },
  "hou-9": { restaurantId: "hou-9", whatToOrder: "The tasting flight and whatever the chef recommends.", insiderTip: "Sit at the bar for the best service." },
  "hou-10": { restaurantId: "hou-10", whatToOrder: "The omakase plate and a sake flight.", insiderTip: "The lunch omakase is the same quality at half the price." },
