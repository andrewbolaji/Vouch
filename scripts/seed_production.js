...
const restaurants = [
  // Houston
  { id: "hou-1", cityId: "houston", name: "Mensho", cuisine: "Ramen", imageUrl: "placeholder://restaurant", description: "Tokyo ramen master Tomoharu Shono's Houston shop. Michelin-recognized, known for a wagyu-meets-Texas-BBQ bowl.", rank: 1, voteCount: 2847, priceLevel: 2, locations: [{ name: "Chinatown", address: "9889 Bellaire Blvd, Ste C308, Houston, TX 77036", latitude: 0, longitude: 0 }], vibeTags: ["Quick Bite", "Cozy", "Neighborhood Favorite"] },
  { id: "hou-2", cityId: "houston", name: "Cool Runnings", cuisine: "Jamaican", imageUrl: "placeholder://restaurant", description: "Authentic Jamaican and Caribbean cooking from a Jamaica-native chef. The brown stew chicken and oxtail are the move.", rank: 2, voteCount: 2534, priceLevel: 2, locations: [{ name: "Southwest Houston", address: "8270 W Bellfort Ave, Houston, TX 77071", latitude: 0, longitude: 0 }], vibeTags: ["Flavor Bomb", "Casual", "Hidden Gem"] },
  { id: "hou-3", cityId: "houston", name: "The Puddery", cuisine: "Dessert", imageUrl: "placeholder://restaurant", description: "Banana pudding in 30-plus flavors, served in a cup, plus the famous Oreo Croffle. The spot Keith Lee called the best dessert of his life.", rank: 3, voteCount: 2298, priceLevel: 2, locations: [{ name: "Pearland", address: "5517 Broadway St, Ste M, Pearland, TX 77581", latitude: 0, longitude: 0 }], vibeTags: ["Sweet Tooth", "Worth the Wait", "Date Night"] },
  { id: "hou-4", cityId: "houston", name: "Lost and Found", cuisine: "Cocktail Bar + Kitchen", imageUrl: "placeholder://restaurant", description: "A lively Midtown bar with colorful craft cocktails, a downtown-view patio, and a famous Travis Scott mural.", rank: 4, voteCount: 2087, priceLevel: 3, locations: [{ name: "Midtown", address: "160 W Gray St, Houston, TX 77019", latitude: 0, longitude: 0 }], vibeTags: ["Good Drinks", "Lively", "Patio Views"] },
  { id: "hou-5", cityId: "houston", name: "Le Jardinier", cuisine: "French", imageUrl: "placeholder://restaurant", description: "Vegetable-forward modern French inside the MFAH. Michelin-starred, from chef Alain Verzeroli.", rank: 5, voteCount: 1876, priceLevel: 4, locations: [{ name: "Museum District", address: "Museum of Fine Arts (Kinder Building), 5500 Main St, Ste 122, Houston, TX 77004", latitude: 0, longitude: 0 }], vibeTags: ["Date Night", "Chef-Driven", "Clean Vibes"] },
  { id: "hou-6", cityId: "houston", name: "Dona Leti's", cuisine: "Mexican", imageUrl: "placeholder://restaurant", description: "H-Mex done big. Family-owned, named for the owners' late mother, famous for quesabirria tacos and massive portions.", rank: 6, voteCount: 1654, priceLevel: 2, locations: [{ name: "Southwest Houston", address: "10425 S Post Oak Rd, Houston, TX 77053", latitude: 0, longitude: 0 }], vibeTags: ["Big Portions", "Family-Owned", "Flavor Bomb"] },
  { id: "hou-7", cityId: "houston", name: "Hidden Omakase", cuisine: "Japanese", imageUrl: "placeholder://restaurant", description: "A hidden, dark 18-seat sushi counter sealed off from the strip mall outside. Chef-led omakase, BYOB.", rank: 7, voteCount: 1432, priceLevel: 4, locations: [{ name: "Galleria / Uptown", address: "5353 W Alabama St, Ste 102, Houston, TX 77056", latitude: 0, longitude: 0 }], vibeTags: ["Special Occasion", "Omakase", "Hidden Gem"] },
  { id: "hou-8", cityId: "houston", name: "Tatemo", cuisine: "Modern Mexican (Masa Tasting Menu)", imageUrl: "placeholder://restaurant", description: "Houston's Michelin-starred Mexican tasting-menu spot, built entirely around heirloom corn and house-nixtamalized masa. Chef Emmanuel Chavez.", rank: 8, voteCount: 1298, priceLevel: 4, locations: [{ name: "Spring Branch", address: "4740 Dacoma St, Houston, TX 77092", latitude: 0, longitude: 0 }], vibeTags: ["Hidden Gem", "Date Night", "Chef-Driven"] },
  { id: "hou-9", cityId: "houston", name: "Corkscrew BBQ", cuisine: "BBQ", imageUrl: "placeholder://restaurant", description: "Pitmaster Will Buckman cooks over all-wood fires. Michelin-starred in 2024. Get there early or eat somewhere else.", rank: 9, voteCount: 1156, priceLevel: 2, locations: [{ name: "Spring", address: "26608 Keith St, Spring, TX 77373", latitude: 0, longitude: 0 }], vibeTags: ["Worth the Drive", "No Frills", "Cash Friendly"] },
  { id: "hou-10", cityId: "houston", name: "Taste Bar + Kitchen", cuisine: "Southern Comfort + Cocktails", imageUrl: "placeholder://restaurant", description: "Globally-spun Southern comfort from chef Don Bowie. An over-the-top chicken-and-waffles menu, craft cocktails, and live entertainment.", rank: 10, voteCount: 1087, priceLevel: 3, locations: [{ name: "Midtown", address: "3015 Bagby St, Houston, TX 77006", latitude: 0, longitude: 0 }], vibeTags: ["Lively", "Group Friendly", "Comfort Food"] },
...
const insiderNotes = {
  ...
  "hou-2": { restaurantId: "hou-2", whatToOrder: "Brown stew chicken, oxtail, and ackee and saltfish.", insiderTip: "They do not take phone orders. Order ahead on DoorDash or come in." },
  "hou-3": { restaurantId: "hou-3", whatToOrder: "Banana pudding (any flavor) and the Oreo Croffle.", insiderTip: "Weekend lines wrap the building. Go early or on a weeknight." },
  ...
  "hou-5": { restaurantId: "hou-5", whatToOrder: "The seasonal tasting menu; the burrata and Ora King salmon are standouts.", insiderTip: "Pair lunch with the museum. Patio seats overlook the sculpture garden." },
  "hou-6": { restaurantId: "hou-6", whatToOrder: "Quesabirria tacos with consome, and a strawberry horchata.", insiderTip: "Portions are huge. Come hungry or plan to share." },
  "hou-7": { restaurantId: "hou-7", whatToOrder: "The omakase. The uni and the wagyu larb hand roll are standouts.", insiderTip: "Reservations are Resy-only and go fast. BYOB with a $20 corkage." },
  "hou-8": { restaurantId: "hou-8", whatToOrder: "The multi-course masa tasting menu (tasting-menu only). BYOB.", insiderTip: "Tasting-menu only, around 13 seats, Thursday to Saturday. Reservations release a few weeks out and vanish fast." },
  ...
  "hou-10": { restaurantId: "hou-10", whatToOrder: "Chicken and waffles (try the chicken-fried lobster version) and a craft cocktail.", insiderTip: "Live music, comedy, and karaoke through the week. Reserve, it gets busy." },
